...
// later metadata/diff/post calls. The non-enumerable `complete` property lets
// the poller distinguish validated discovery from partial or legacy results
// while preserving the array contract for existing callers. It does not claim
// that concurrent changes produced an atomic snapshot.
