...
// Windows cannot safely unlink a failed replacement through a pathname after
// its descriptor has been closed. Bound retained replacement artifacts per
// parent instead of attempting unsafe scavenging.
export const MAX_REVIEW_STATE_TEMPORARIES = 8;
