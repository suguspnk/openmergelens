...
// they refer to the same object. Path-to-path checks always require the
// complete volume/file tuple; handle/path callers may explicitly opt into
// ino-only binding for this known Windows representation divergence.
