...
export async function saveState(
  ...
  try {
    ...
    // Closing before rename preserves Windows portability. No pathname chmod
    // occurs: a replacement between the identity check and rename can only
    // replace state.json, never change permissions on an attacker-chosen file.
    await handle.close();
    handle = undefined;
